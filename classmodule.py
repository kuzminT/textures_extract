...
class ConvertAtlas:
    ...
    :todo: Доделать расчёт для выделения фреймов из spritesheet: если количество фреймов выходит за ширину изображения, перемещаться на уровень ниже
    :todo: Добавить графический интерфейс к программе
    """
